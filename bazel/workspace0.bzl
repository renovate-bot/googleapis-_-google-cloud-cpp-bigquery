...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://github.com/grpc/grpc/archive/v1.80.0-pre1.tar.gz",
        ],
        sha256 = "471d50a6d80cb9d3b4949d1b5d9ed1960c7b811dde493e8fadb90048c74ec724",
        strip_prefix = "grpc-1.80.0-pre1",
    )
