...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://github.com/protocolbuffers/protobuf/archive/v34.0-rc2.tar.gz",
        ],
        sha256 = "5f4dd806648b77e5015f51a20f38949c4741d43f8707fc1e77b039af54eb8947",
        strip_prefix = "protobuf-34.0-rc2",
    )
