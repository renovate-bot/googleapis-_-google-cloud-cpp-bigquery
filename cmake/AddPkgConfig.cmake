...
#
function (google_cloud_cpp_bigquery_add_pkgconfig library name description)
    ...
    if (_opt_WITH_SHORT_TARGET)
        ...
        set(target "google_cloud_cpp_bigquery_${library}")
    endif ()
    ...
    if ("${target_type}" STREQUAL "INTERFACE_LIBRARY")
        ...
        set(GOOGLE_CLOUD_CPP_PC_LIBS "-lgoogle_cloud_cpp_bigquery_${library}")
    endif ()
    ...
    configure_file("${PROJECT_SOURCE_DIR}/cmake/templates/config.pc.in"
                   "google_cloud_cpp_bigquery_${library}.pc" @ONLY)
    install(
        FILES
            "${CMAKE_CURRENT_BINARY_DIR}/google_cloud_cpp_bigquery_${library}.pc"
