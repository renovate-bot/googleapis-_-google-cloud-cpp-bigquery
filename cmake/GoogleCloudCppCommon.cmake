...
#
function (google_cloud_cpp_bigquery_install_headers target destination)
...
function (google_cloud_cpp_bigquery_add_samples_relative library path)
    file(
        GLOB sample_files
    ...
    foreach (source IN LISTS sample_files)
        ...
        if (TARGET google-cloud-cpp-bigquery::${library})
            target_link_libraries(
                "${target}" PRIVATE google-cloud-cpp-bigquery::${library}
                                    google_cloud_cpp_bigquery_testing)
        elseif (TARGET google-cloud-cpp-bigquery::experimental-${library})
            target_link_libraries(
                "${target}"
                PRIVATE google-cloud-cpp-bigquery::experimental-${library}
                        google_cloud_cpp_bigquery_testing)
        endif ()
...
function (google_cloud_cpp_bigquery_install_mocks library display_name)
    set(library_target "google_cloud_cpp_bigquery_${library}")
    set(mocks_target "google_cloud_cpp_bigquery_${library}_mocks")
    install(
    ...
    install(
        ...
        EXPORT ${mocks_target}-targets
        COMPONENT google_cloud_cpp_bigquery_development)
    google_cloud_cpp_bigquery_install_headers("${mocks_target}"
