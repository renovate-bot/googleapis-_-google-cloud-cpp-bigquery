...
#ifndef GOOGLE_CLOUD_CPP_BIGQUERY_GOOGLE_CLOUD_BIGQUERY_UNIFIED_TESTING_UTIL_STATUS_MATCHERS_H
#define GOOGLE_CLOUD_CPP_BIGQUERY_GOOGLE_CLOUD_BIGQUERY_UNIFIED_TESTING_UTIL_STATUS_MATCHERS_H
...
#define EXPECT_STATUS_OK(expression) \
  EXPECT_THAT(expression,            \
              ::google::cloud::bigquery_unified::testing_util::IsOk())
...
#endif  // GOOGLE_CLOUD_CPP_BIGQUERY_GOOGLE_CLOUD_BIGQUERY_UNIFIED_TESTING_UTIL_STATUS_MATCHERS_H
